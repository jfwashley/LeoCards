...
- [x] 18-04-PLAN.md — perf-recert.mjs orchestrator (CWV half + nav-gate half) + perf:recert script (PERF-06)
...
- [x] 27-02-PLAN.md — Secondary DB indexes + gated Neon db:push (item 14, PERF-18) [checkpoint]
...
- [x] 27-04-PLAN.md — Dashboard data-pass consolidation (item 12, PERF-16)
- [x] 27-07-PLAN.md — Client bundle diet: zod → zod/mini (item 10, PERF-14)
...
**Status**: In Progress — 3/9 plans complete (28.1-03 shipped 2026-08-03); next: 28.1-04
...
| 28.1 Native foundation — workspace & API | 3/9 | In Progress|  |
