...
updated: 2026-07-22T14:45:00.000Z
---
...
result: PASS (2026-07-22, post-D-07 deploy) — `curl -sI https://leocards.vercel.app/habitat/clips/l1-excited.mp4` returned `HTTP/1.1 200` with `Cache-Control: public, max-age=31536000, immutable`; control asset /favicon.ico returned `max-age=0, must-revalidate`, confirming the header comes from next.config headers() and not a blanket Vercel default. Research assumption A2 verified in prod.
