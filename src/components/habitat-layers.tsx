...
const LEVEL_LAYERS = {
  ...
  2: ["layer-sky", "layer-hills", "layer-grass-base", "layer-tree-1", "layer-rocks-1"],
  3: ["layer-sky", "layer-hills", "layer-grass-base", "layer-tree-1", "layer-rocks-1", "layer-tree-2"],
  4: ["layer-sky", "layer-hills", "layer-grass-base", "layer-tree-1", "layer-rocks-1", "layer-tree-2", "layer-flowers-1"],
  5: ["layer-sky", "layer-hills", "layer-grass-base", "layer-tree-1", "layer-rocks-1", "layer-tree-2", "layer-flowers-1", "layer-water-1"],
  6: ["layer-sky", "layer-hills", "layer-grass-base", "layer-tree-1", "layer-rocks-1", "layer-tree-2", "layer-flowers-1", "layer-water-1", "layer-animal-1"],
  7: ["layer-sky", "layer-hills", "layer-grass-base", "layer-tree-1", "layer-rocks-1", "layer-tree-2", "layer-flowers-1", "layer-water-1", "layer-animal-1", "layer-tree-3"],
  8: ["layer-sky", "layer-hills", "layer-grass-base", "layer-tree-1", "layer-rocks-1", "layer-tree-2", "layer-flowers-1", "layer-water-1", "layer-animal-1", "layer-tree-3", "layer-flowers-2"],
  9: ["layer-sky", "layer-hills", "layer-grass-base", "layer-tree-1", "layer-rocks-1", "layer-tree-2", "layer-flowers-1", "layer-water-1", "layer-animal-1", "layer-tree-3", "layer-flowers-2", "layer-animal-2"],
  10: ["layer-sky", "layer-hills", "layer-grass-base", "layer-tree-1", "layer-rocks-1", "layer-tree-2", "layer-flowers-1", "layer-water-1", "layer-animal-1", "layer-tree-3", "layer-flowers-2", "layer-animal-2", "layer-water-2"],
} as const;
...
export function HabitatLayers({ level, quality, sheet, sceneWidth, sceneHeight }: HabitatLayersProps) {
          ...
          if (levelIndex >= 0) {
            ...
            const resilienceFactor =
              levelAddedCount > 1
                ...
                : 0;
            alpha = Math.min(1, decayAlpha + resilienceFactor * (1 - decayAlpha));
          }
        }
