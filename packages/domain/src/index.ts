...
// via `@leocards/domain/study` and `@leocards/domain/habitat` as their own
// distinct subpaths, never folded in here, so that per-module
// `vi.mock("@leocards/domain/study", ...)` /
